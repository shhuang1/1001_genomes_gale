...
def main():
    ...
    if ('calc_kinship' in step_list):
        ...
        kinship.save_kinship_to_file(os.path.join(out_dir,'kinship_maf1.hdf5'),K,geno.accessions,geno.num_snps)
    else:
        load_k = kinship.load_kinship_from_file(os.path.join(out_dir,'kinship_maf1.hdf5'),scaled=False)
    ...
    for k in range(4,5):
        ...
        for i in range(0,5000):
            ...
            run_lmm(snps,RNA,COV,i,scaledK,os.path.join(out_dir_k,'%s.csv'%RNA_genes[i]))
