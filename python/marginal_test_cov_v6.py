# coding: utf-8
# sample_relatedness computed by LIMIX
...
def main():
    ...
    if 1:
        geno_file,pheno_file,norm_mode,cov_file,RNA_start,RNA_end,out_dir = sys.argv[1:]
    ...
    if 0:
        ...
        pheno_file = '/gale/netapp/home/shhuang/projects/1001_genomes/ath1001_tx_norm_2016-04-21/ath1001_tx_norm_2016-04-21-UQRIN_gNorm_k4_vst2_cv0p05_UQRIN_1001gT.hdf5'
        norm_mode = 'RIN'
        out_dir = 'test_v6'
        cov_file = '/gale/netapp/home/shhuang/projects/1001_genomes/ath1001_tx_norm_2016-04-21/ath1001_tx_norm_2016-04-21-gNorm_W_k4.txt'
