...
this_analysis_path = file.path(PROJ_RESULTS_PATH,"wgcna_analysis_2016-03-08")
prefix.string = file.path(this_analysis_path,"graphics","wgcna_analysis_2016-03-08-")
rdata_prefix = file.path(this_analysis_path,"wgcna_analysis_2016-03-08-")

deg_lrt_list_file = file.path(PROJ_RESULTS_PATH,'acc_variable_genes_2016-02-29/acc_variable_genes_2016-02-29-lrt_list.RData')
...
opts_chunk$set(fig.path=prefix.string, fig.align='center', fig.show='hold',
               ...
               cache.path = 'cache/wgcna_analysis_2016-03-08-')
...
\item Use batch normalized, variance stabilized gene expression, filtered to genes with covariance greater than 0.05: \verb|\Sexpr{gNorm_normCounts_k4_cv5_file}|.
\end{itemize}
...
genelist_summary_subr123 = genelist_summary[match(c('relict M1','nonrelict M3','nonrelict M2',
...
dap_enrich_modselect = c('relict M4','nonrelict M4','relict M5','nonrelict M5',
                         'relict M1','nonrelict M3','nonrelict M2',
                         'relict M2','nonrelict M1','nonrelict M7',
                         'relict M3','nonrelict M6',
...
pdf(paste0(prefix.string,'dap_mod_enrich3_r45.pdf'),width=3.6,height=4)
...
dap_enrich_modselect_r123 = c('relict M1','nonrelict M3','nonrelict M2',
                              'relict M2','nonrelict M1','nonrelict M7',
                              'relict M3','nonrelict M6')
