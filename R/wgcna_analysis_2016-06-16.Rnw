...
this_analysis_path = file.path(PROJ_RESULTS_PATH,"wgcna_analysis_2016-06-16")
prefix.string = file.path(this_analysis_path,"graphics","wgcna_analysis_2016-06-16-")
rdata_prefix = file.path(this_analysis_path,"wgcna_analysis_2016-06-16-")
...
opts_chunk$set(fig.path=prefix.string, fig.align='center', fig.show='hold',
               ...
               cache.path = 'cache/wgcna_analysis_2016-06-16-')
