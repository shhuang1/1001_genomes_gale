...
this_analysis_path = file.path(PROJ_RESULTS_PATH,"dmr_dap_orlap_2016-05-01")
prefix.string = file.path(this_analysis_path,"graphics","dmr_dap_orlap_2016-05-01-")
step_list = ""
@
...
opts_chunk$set(fig.path=prefix.string, fig.align='center', fig.show='hold',
               ...
               cache.path="cache/dmr_dap_orlap_2016-05-01-")
...
dmc_feat_names = c('dapfimo2','dapfimo4')
...
#pdf(paste0(prefix.string,'aa3.pdf'),width=1.4,height=1.4)
p2c + geom_point(aes(x=l2fold.snp.dapfimo4,y=log2fc.dap.MR_mC),alpha=0.5,size=0.5) +
    scale_x_continuous("log2 TFBS FE in eQTL")
#dev.off()
@ 

<<gat_dapfc_scatter2,fig.width=2.4,fig.height=1.4>>=
scatter2_plot = rbindlist(list(exp_gat_wide0[l2fold.dmCH_filtered.dapfimo4>-6,list(x=log2fc.dap.MR_mC,y=l2fold.dmCH_filtered.dapfimo4,allele='eQTL CH-DMB')],
                               exp_gat_wide0[,list(x=log2fc.dap.MR_mC,y=l2fold.snp.dapfimo4,allele='eQTL')]))
scatter2_plot[,allele:=factor(allele,levels=c("eQTL CH-DMB","eQTL"))]
mc_cor_plot = data.table('allele'=c("eQTL CH-DMB","eQTL"),
                         x=c(3,3),y=c(-4,-3),
                         pcor=mc_cor['log2fc.dap.MR_mC',c('l2fold.dmCH_filtered.dapfimo4','l2fold.snp.dapfimo4')])
mc_cor_plot[,allele:=factor(allele,levels=c("eQTL CH-DMB","eQTL"))]
...
<<exp_gat_hm3,fig.width=1.8,fig.height=3>>=
...
exp_gat_hm3_mat = as.matrix(exp_gat_hm3_plot[,list("eQTL enrichment"=l2fold.snp.dapfimo4,
                                                   "eQTL CH-DMB enrichment"=l2fold.dmCH_filtered.dapfimo4,
...
aheatmap(exp_gat_hm3_mat,Colv=NA,col=tim.colors(50),breaks=0,cexCol=0.6,treeheight=10,na.color="grey50",hclustfun="single")
#dev.off()
@ 
...
p5b = p5a + geom_point(aes(x=icsum.cg,y=l2fold.dmCH_filtered.dapfimo4),
