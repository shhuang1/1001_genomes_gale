...
this_analysis_path = file.path(PROJ_RESULTS_PATH,"acc_map_2016-04-19")
prefix.string = file.path(this_analysis_path,"graphics","acc_map_2016-04-19-")
step_list = ""
@
...
opts_chunk$set(fig.path=prefix.string, fig.align='center', fig.show='hold',
               ...
               cache.path="cache/acc_map_2016-04-19")
...
\title{Mapped reads per accession}
\date{April 19, 2016}
